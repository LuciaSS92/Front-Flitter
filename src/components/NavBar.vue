<template>
  <nav>
    ...
    <div>
        <svg xmlns="http://www.w3.org/2000/svg" @click="logout" width="16" height="16" fill="black" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
...
export default defineComponent({
  ...
  methods: {
    logout() {
      ...
      // need to link to auth - i.e auth.logout();
