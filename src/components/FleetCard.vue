<template>
    <div>
        ...
        <button @click="visitUserProfile(fleet.userName)">
    ...
    <div></div>
    <div class="likes">
        <svg class="feather feather-heart sc-dnqmqq jxshSx" xmlns="http://www.w3.org/2000/svg" width="0.8rem"
            length-adjust="auto" viewBox="1 2 24 24" fill="red" stroke="currentColor" stroke-width="2"
